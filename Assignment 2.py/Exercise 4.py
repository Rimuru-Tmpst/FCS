...
def get_valid_indices():
    while True:
        try:
            start = int(input("Enter the starting index (0 to {}): ".format(len(words) - 1)))
            end = int(input("Enter the ending index ({} to {}): ".format(start, len(words) - 1)))
...
start_index, end_index = get_valid_indices()

print("Slice of words:", words[start_index:end_index + 1])
